...
class HH {
  constructor() {
    ...
    this.el = el(".hh", [
      ...
      new Row("Sex", (this.sex = new Select({ options: ["man", "woman"], onchange: onchange }))),
      new Row(
        "Genotype",
        (this.genotype = new Select({
      ...
      new Row(
        "Current Treatment",
        (this.currentTreatment = new Select({
          options: [
      ...
      new Row("Subjective", (this.subjective = new Text(""))),
      new Row(""),
      new Row("Objective", (this.objective = new Text(""))),
      new Row(""),
      new Row("Actual Interval", (this.actualInterval = new NumberDivisionInput("0", "20", 7, "6", "weeks", onchange))),
      new Row("Measured Ferritin", (this.ferritin = new NumberInput("0", "500", "100", "ng/ml", onchange))),
      new Row("HGB", (this.hgb = new NumberIncrementInput("0", "30", "0.1", "14", "g/dl", onchange))),
      new Row("Assessment", (this.assessment = new Text(""))),
      new Row(""),
      new Row("Target Ferritin", (this.targetFerritin = new Text(""))),
      new Row("New Interval", (this.newInterval = new NumberInput("0", "20", "6", "weeks", onchange))),
      new Row("Next", (this.next = new Select({ options: ["Continue", "Schedule"], onchange: onchange }))),
      new Row("Plan", (this.plan = new Text(""))),
      new Row(""),
      new Row("Reviewer", (this.reviewer = new TextInput(onchange))),
      new Row("Reviewed", (this.reviewed = new Text(""))),
      new Row(""),
      new Row("Copy", (this.copy = new Copy(""))),
      new Row(new Fill()),
    ]);
